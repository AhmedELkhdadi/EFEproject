<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <head>
        ...
        <!-- Favicons -->
        <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/DashboardAssets/img/fav.png">
...
.file {
        ...
        <header id="header" class="header-scrolled shadow">
            <div class="container">
                ...
                <div id="logo" class="pull-left">
                    <a href="${pageContext.request.contextPath}/" class="scrollto newLogo"><img style="transform : scale(1.5);" src="${pageContext.request.contextPath}/assets/img/newlogo.png" alt=""></a>
                </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div
                            ...
                            <div class="lh-1 text-center">
	                            ...
	                            <h4 class="text-light"> Event starts in <b id="blockCountdown" class="text-light" style="display:none"> ${ msUntillStart }</b> </h4>                            	
	                            </c:when>
	                            <c:when test="${ eventState == 1 }">
	                            	<c:choose>
	                            		...
	                            		<c:otherwise>
	                            			...
	                            			<div class="w-100 text-center m-0 p-0">Conference link: <a href="${currentActivity.getMeetLink()}" target="_blank" class="text-white m-0 p-0"><b>${currentActivity.getMeetLink()}</b></a></div>
	                            			</p>
	                            			</c:if>
	                            		</c:otherwise>
	                            	</c:choose>                          	
                        ...
                        <div class="row p-0">
                            ...
                            <ul class="nav nav-pills nav-justified nav-just mb-3" id="pills-tab" role="tablist">
							  <li class="nav-item" role="presentation">
							    <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Participant</a>
							  </li>
							  <li class="nav-item" role="presentation">
							    <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">Representative</a>
							  </li>
							...
							<div class="tab-content" id="pills-tabContent">
							  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <div class="card-body mx-4 mt-3">
                                    ...
                                    <div class="md-form">
                                        <input type="text" name="loginP"  id="Form-email4" class="form-control loginsignup"  required>
                                    ...
                                    <div class="md-form">
                                        ...
                                        <input type="text" name="nameP"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Name</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="fnameP"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Family Name</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="emailP"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Email</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="telP"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Phone Number</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="number" name="age"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Age</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        <input type="text" name="SF"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Study Field</label>
                                    </div>
                                    <div class="md-form pb-0">
                                        <input type="password" name="passwordP"  id="Form-pass4" class="form-control" minlength="6" required>
                                     ...
                                     <label style="width : 100%;" class="file">
                               			<input type="file" id="" name="Pimage" required aria-label="File browser example">
                               			<span class="file-custom"></span>
                               		</label>
                                     <span style="color:gray;">Provide a formal picture of yourself alone, and with a good quality<br> 
                                     (<strong>Your account wont be approvedif the image is not accepted</strong>)
                                     </span>
                                    ...
                                    <div class="text-center mb-4">
                                        <button type="submit" name="signUp" class="btn btn-primary btn-block z-depth-2">Sign up</button>
                                        <c:if test="${ applyRes != null }">
                                		<c:out value="${applyRes ? 'Account added' : 'Error occured' }" />
                            			</c:if>
                                    </div>
                                    <p class="font-small grey-text d-flex justify-content-center">Already have an account?
                                        <a href="#"  class="dark-grey-text font-weight-bold ml-1">Log in</a>
                                    </p>
									</form>
                                </div>
							  ...
							  <div class="card">
                                <div class="card-body mx-4 mt-3">
                                    ...
                                    <div class="md-form">
                                        <input type="text" name="loginR"  id="Form-email4" class="form-control loginsignup" required>
                                        <label for="Form-email4">User Name</label>
                                        <span class="loginAvailability" hidden=true style="margin-left:7px;"></span>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="nameR"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Name</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="fnameR"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Family Name</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="emailR"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Email</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="telR"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Phone Number</label>
                                    </div>
                                    
                                    <div class="md-form pb-0">
                                       
                                        <input type="password" name="passwordR"  id="Form-pass4" class="form-control" minlength="6" required>
                                        <label for="Form-pass4">Password</label>
                                    ...
                                    <div class="md-form">
                                        ...
                                        <input type="text" name="entName"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Name</label>
                                    </div>
                                    
                                     <div class="md-form pb-0">
                                       
                                        <input type="text" name="slogan"  id="Form-pass4" class="form-control" required>
                                    ...
                                    <div class="md-form">
                                        ...
                                        <textarea class="form-control md-textarea" name="entDesc" id="exampleFormControlTextarea1" rows="3" required></textarea>
                                        <label for="Form-email4">Description</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="entEmail"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Email</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        
                                        <input type="text" name="entLoc"  id="Form-email4" class="form-control" required>
                                        <label for="Form-email4">Location</label>
                                    </div>
                                    
                                    <div class="md-form">
                                        <input type="text" name="entDomain"  id="Form-email4" class="form-control" required>
 ...
 <br>
                                    ...
                                    <div class="text-center mb-4">
                                        <button type="submit" name="apply" class="btn btn-primary btn-block z-depth-2">Apply</button>
                                        <c:if test="${ applyRes != null }">
                                <c:out value="${applyRes ? 'Account added' : 'Error occured' }" />
                            </c:if>
                                    </div>
                                    <p class="font-small grey-text d-flex justify-content-center">Already have an account?
                                        <a href="${pageContext.request.contextPath}/login" class="dark-grey-text font-weight-bold ml-1"> Log in</a>
                                    </p>
									</form>
                                </div>
                            </div> 
