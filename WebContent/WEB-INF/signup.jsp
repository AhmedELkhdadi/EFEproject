							  ...
							  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <div class="card-body mx-4 mt-3">
                                    ...
                                    <div class="md-form pb-0">
                                        <input type="password" name="passwordP"  id="Form-pass4" class="form-control" required>
							  ...
							  <div class="card">
                                <div class="card-body mx-4 mt-3">
                                    ...
                                    <div class="md-form pb-0">
                                        ...
                                        <input type="password" name="passwordR"  id="Form-pass4" class="form-control" required>
                                        <label for="Form-pass4">Password</label>
