        ...
        <div class="container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li class="buy-tickets" style="cursor:pointer;"><a href="${pageContext.request.contextPath }/">Go Back</a></li>
                </ul>
            </nav>
            <!-- #nav-menu-container -->
        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="hotel shadow">
                            ...
                            <c:if test="${  user.getStatus() != 2 && rep.getEntreprise().getMeetLink() != null  }">
				            	...
				            	<a href="${ rep.getEntreprise().getMeetLink() }" target="_blank">${ rep.getEntreprise().getMeetLink() }</a>
				            	</strong>
