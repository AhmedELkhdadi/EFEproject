            ...
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li class="buy-tickets" style="cursor:pointer;"><a
                                href="${pageContext.request.contextPath }/">Go Back</a></li>
                    </ul>
                </nav>
                <!-- #nav-menu-container -->
            </div>
            ...
            <section style="margin-top: -50px;" id="hotels" class="section-with-bg">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div style="margin-top: -20px;" class="row" data-aos="fade-up" data-aos-delay="100">
                        <c:if test="${ appReps.size() == 0 }">
                            <p>No Stands Available At The Moment</p>
                        </c:if>
                        <c:forEach items="${ appReps }" var="rep">
                            <div class="col-lg-4 col-md-6">
                                <div class="hotel shadow">
                                    <div class="hotel-img">
                                        <a href="${pageContext.request.contextPath }/workshop?Rep=${rep.getId()}"><img
                                                src="${pageContext.request.contextPath}/assets/img/EnterpriseBanners/${rep.getEntreprise().getBannerImage()}"
                                                alt="Stand 1" class="img-fluid" style="height:90px; width:100%"></a>
                                    </div>
                                    <div
                                        style="margin-top:-15px; height : 220px; overflow-y: scroll; border-bottom: 1px solid #F1F1F1; padding:10px;">
                                        <h3><a href="${pageContext.request.contextPath }/workshop?Rep=${rep.getId()}">${
                                                rep.getEntreprise().getName() }</a></h3>
                                        <h3 class=""><small>Representative: <strong>${ rep.getName()} ${ rep.getFname()}
                                                </strong></small></h3>
                                    ...
                                    <c:if test="${ eventState == 1 }">
                                        <c:if test="${ currentActivity.getName() == 'Stands and Workshops' }">
                                            <div class="w-100 pb-2 text-center pt-3" style="height:30px">
                                                <c:if
                                                    test="${  user.getStatus() != 2 && rep.getEntreprise().getMeetLink() != null  }">

                                                    <strong class="text-info">
                                                        <a href="${ rep.getEntreprise().getMeetLink() }"
                                                            target="_blank">${ rep.getEntreprise().getMeetLink() }</a>
                                                    </strong>
                                    ...
                                    <div
                                        ...
                                        <a class="btn btn-primary btn-sm shadow text-white"
                                            href="${pageContext.request.contextPath }/workshop?Rep=${rep.getId()}">More
                                            Details</a>
                                    </div>
                                </div>
                            </div>
