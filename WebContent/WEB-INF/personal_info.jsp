...
<body>
    ...
    <header id="header" class="header-fixed">
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                <a href="index" class="scrollto newLogo"><img style="transform : scale(1.3);" src="${pageContext.request.contextPath}/assets/img/newlogo.png" alt=""></a>
            </div>
    ...
    <main id="main" class="container">
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-10 d-flex align-items-center p-3 mt-0 mb-0 text-white bg-primary rounded shadow justify-content-center">
                ...
                <div class="row z-depth-3">
                    <div class="col-sm-4 bg-primary rounded-left">
                        <div class="card-block text-center text-white"><br>
                            <img src="assets/img/participants/${ participant.getImage() }" style="max-width:190px;max-height:250px;width: auto;height: auto;border-radius:5px"/>
                    ...
                    <div class="col-sm-8 bg-white rounded-right">
                        ...
                        <div class="row">
                            <div id="training" class="col-sm-6">
                                ...
                                <c:choose>
                                <c:when test="${ participant.getTraining() == null || participant.getTraining() == '' }">
                                <h6 class="text-muted">Information not yet submitted.</h6>
                                </c:when>
                                <c:otherwise>
                                 <h6 class="text-muted availableTraining"><b>${ participant.getTraining() }</b></h6>
                                </c:otherwise>
                                </c:choose>
                            ...
                            <div id="award" class="col-sm-6">
								...
								<c:choose>
                                <c:when test="${ participant.getAwards() == null || participant.getAwards() == '' }">
                                <h6 class="text-muted">Information not yet submitted.</h6>
                                </c:when>
                                <c:otherwise>
                                <h6  class="text-muted availableAwards"><b>${ participant.getAwards() }</b></h6>
                                </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div id="ts" class="col-sm-6">
                                ...
                                <c:choose>
                                <c:when test="${ participant.getTechSkills() == null || participant.getTechSkills() == '' }">
                                <h6 class="text-muted">Information not yet submitted.</h6>
                                </c:when>
                                <c:otherwise>
                                <h6 class="text-muted availableTs"><b>${ participant.getTechSkills() }</b></h6>
                                </c:otherwise>
                                </c:choose>
                            </div>
                            <div id="ss" class="col-sm-6">
                                ...
                                <c:choose>
                                <c:when test="${ participant.getSoftSkills() == null || participant.getSoftSkills() == '' }">
                                <h6 class="text-muted">Information not yet submitted. </h6>
                                </c:when>
                                <c:otherwise>
                                <h6 class="text-muted availableSs"><b>${ participant.getSoftSkills() }</b> </h6>
                                </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div id="lg"  class="col-sm-6">
                                ...
                                <c:choose>
                                <c:when test="${ participant.getLangages() == null || participant.getLangages() == '' }">
                                <h6 class="text-muted">Information not yet submitted.</h6>
                                </c:when>
                                <c:otherwise>
                                <h6 class="text-muted availableLg"><b>${ participant.getLangages() }</b></h6>
                                </c:otherwise>
                                </c:choose>
                            </div>
                            <div id="int" class="col-sm-6">
                                ...
                                <c:choose>
                                <c:when test="${ participant.getIntrests() == null || participant.getIntrests() == '' }">
                                <h6 class="text-muted">Information not yet submitted.</h6>
                                </c:when>
                                <c:otherwise>
                                <h6 class="text-muted availableInt"><b>${ participant.getIntrests() }</b></h6>
                                </c:otherwise>
                                </c:choose>
                            </div>
                        </div>
                        ...
                        <ul class="list-unstyled d-flex justify-content-center mt-4">
                            <li><a class="btn btn-sm btn-circle" id="linkedIn" href="${ participant.getLinkedIn() }" style="background-color:#0a66c2;"><i class="fab fa-linkedin h6 text-white"></i></a></li>
                            <li><a class="btn btn-dark btn-sm btn-circle" id="git" href="${ participant.getGitHub() }"><i class="fab fa-git h6 text-white"></i></a></li>
                            <li><a class="btn btn-primary btn-sm btn-circle" id="fb" href="${ participant.getFacebook() }"><i class="fab fa-facebook-f  h3 text-white font-small"></i></a></li>
                        </ul>
