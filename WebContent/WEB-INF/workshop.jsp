                         ...
                         <c:if test="${ eventState == 1 }">
	                        <c:if test="${ currentActivity.getName() == 'Stands and Workshops' }"> 
		                        ...
		                        <c:when test="${ user.getStatus() != 2 && standRep.getEntreprise().getMeetLink() != null  }">
				                        	...
				                        	<a href="${ standRep.getEntreprise().getMeetLink() }" target="_blank">${ standRep.getEntreprise().getMeetLink() }</a>
				                        	</strong>
		                        </c:when>
			                        ...
			                        <div class="card-footer">
			                            <form action="#" method="post" class="responseFrom" style="margin-bottom: -15px;">
			                                <div class="input-group mb-3">
			                                    ...
			                                    <input type="text" class="form-control" name="message" placeholder="Comment...." autocomplete="off" aria-label="Recipient's username" aria-describedby="button-addon2">
