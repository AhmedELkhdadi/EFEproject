...
<head>
    ...
    <!-- bootstrap select CSS
		============================================ -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/DashboardAssets/css/bootstrap-select/bootstrap-select.css">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area" style="margin-top:-20px;margin-bottom:-20px;position:relative;right:50px">
                         <a href="${pageContext.request.contextPath}/"><img style="transform : scale(0.7);" src="${pageContext.request.contextPath}/DashboardAssets/img/logo/newlogodash.png" alt="" /></a> 
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <li class="nav-item nc-al" style="position:relative;top:15px"><a onclick="goBack()" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-left-arrow"></i></span></a>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-menus"></i> Event Tasks</a>
                        </li>
                            ...
                            <div id="participant_tab" class="table-responsive">
                                <table id="data-table-basic" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="${pageContext.request.contextPath }/participant?id_p=${participant.getId()}">${ participant.getFullName() }</a></td>
                                            <td>${ participant.getEmail() }</td>
                                            <td>${ participant.getTel() }</td>
                                            
                                            <td>${ participant.getAge() }</td>
                                            <td><c:if test="${ participant.getSexe() == 'M' }"><span style="color : white; background : #F44336;" class="badge rounded-pill bg-primary">Male</span></c:if>
                                            <c:if test="${ participant.getSexe() == 'F' }"><span style="color : white; background : #00C292;" class="badge rounded-pill bg-primary">Female</span></c:if>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="contact-list mg-t-30">
                            <div class="contact-win">
                                <div>
                                    <img style="width:100px;height:100px;border-radius:50%" src="assets/img/participants/${ participant.getImage() }"
                                        alt="" />
                                </div>
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            ...
                            <div class="contact-ctn">
                                <div class="contact-ad-hd">
                                    ...
                                    <p class="ctn-ads">${ participant.getAge() }years old  <c:if test="${ participant.getSexe() == 'M' }"><span style="color : white; background : #F44336;" class="badge rounded-pill bg-primary">Male</span></c:if>
                                            <c:if test="${ participant.getSexe() == 'F' }"><span style="color : white; background : #00C292;" class="badge rounded-pill bg-primary">Female</span></c:if> </p>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="breadcomb-wp">
                                        ...
                                        <div class="breadcomb-ctn">
                                            ...
                                            <p>Here are some charts to help you know more about the particpants, the enterprises etc.. </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="view-mail-list sm-res-mg-t-30" >
                            ...
                            <div class="cmp-int mg-t-20">
                                ...
                                <input type="file"  name="imageSpeaker" aria-label="File browser example" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="nk-int-st cmp-int-in cmp-email-over">
                                                <input type="text" name="descSpeaker" class="form-control" placeholder="Description of the speaker" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                	<button name="addSpeakerBtn" type="submit" class="btn btn-primary notika-btn-primary waves-effect">Add Speaker</button>
                                </div> 
                                </div>      
                            </div>
                            </form>
                            ...
                            <div id="participant_tab" class="table-responsive">
                                <table id="data-table-basic-speaker" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img src="${pageContext.request.contextPath}/assets/img/speakers/${speaker.getImage()}" alt="Speaker" class="img-fluid" style="width:45px;height:45px; border-radius:50%;"></td>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    ...
                                    <c:forEach items="${ speakers }" var="speaker">
                                            ...
                                            <option value="${ speaker.getId() }">${ speaker.getName() } ${ speaker.getFname() }</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="nk-int-st cmp-int-in cmp-email-over">
                                                <input type="text" name="activityName" class="form-control" placeholder="    New Activity Name" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <button name="addActivityBtn" type="submit" class="btn btn-primary notika-btn-primary waves-effect">Update Activity</button>
                                </div> 
                                </div>      
                            </div>
                            </form>
                                ...
                                <table id="data-table-basic-activity" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <span style="color : white; background : #FF9800;" class="badge rounded-pill bg-primary">${ activity.getStartTime() } - ${ activity.getEndTime() }</span> </td>
                                            <td>${ activity.getSpeaker().getName() } ${ activity.getSpeaker().getFname() }
                                            <c:if test="${ activity.getSpeaker() == null }"><span> <i>No speaker</i>  </span></c:if></td>
                                            <td> <span style="color : white; background : #00C292;" class="badge rounded-pill bg-primary">Day 1</span> </td>
                                        </tr>
                                        </c:forEach>
                                        <c:forEach items="${ activities2 }" var="activity">
                                        <tr>
                                            ...
                                            <td>${ activity.getSpeaker().getName() } ${ activity.getSpeaker().getFname() }
                                            <c:if test="${ activity.getSpeaker() == null }"><span> <i>No speaker</i>  </span></c:if></td>
                                            <td> <span style="color : white; background : #F44336;" class="badge rounded-pill bg-primary">Day 2</span> </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                    <tfoot>
 ...
 $(document).on("submit", "#addActivityForm", function(event) {
    ...
    <!-- bootstrap select JS
		============================================ -->
    <script src="${pageContext.request.contextPath}/DashboardAssets/js/bootstrap-select/bootstrap-select.js"></script>
