    ...
    <header id="header">
        ...
        <div class="container">
            ...
            <div id="logo" class="pull-left">
                ...
                <a href="#" class="scrollto newLogo"><img style="transform : scale(1.8);" src="${pageContext.request.contextPath}/assets/img/newlogo.png" alt="" title=""></a>
            </div>
                    ...
                    <form action="#" method="post"  id="mailform">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input type="text" name="name" class="form-control shadow-sm rounded-sm border-0" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required/>
                                <div class="validate"></div>
                            </div>
                            <div class="form-group col-md-6">
                                <input type="email" class="form-control shadow-sm rounded-sm border-0" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" required/>
                                <div class="validate"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control shadow-sm rounded-sm border-0" name="subject" id="subject" placeholder="Subject" autocomplete="off" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject" required/>
                            <div class="validate"></div>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control shadow-sm rounded-sm border-0" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message" required></textarea>
                            <div class="validate"></div>
                        </div>
                        
                        <div class="text-center"><button type="submit" class="btn btn-primary btn-sm shadow" name="sendmail" >Send Message</button></div>
                    </form>
                </div>
