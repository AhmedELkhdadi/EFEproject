...
public class indexServlet extends HttpServlet {
	...
	private static javax.mail.Message prepareMessage(Session session, String myAccountEmail, String recepient,
			String mail, String subject, String msg, String name) {
		try {
			...
			htmlCode = "<div style='width:65%;margin:auto;'>"
					...
					+ "<p>Message from " + name + " - " + mail + "</p> <br> <p>Subject : <strong>" + subject
					+ "</strong></p> </div>" + "<p style='width:100%;text-align:center;color:black;'>" + msg + "</p>"
					+ "</div>";
